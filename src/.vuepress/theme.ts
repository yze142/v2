...
import { enNavbar, zhNavbar ,xiaoYuNavbar} from "./navbar/index.js";
...
export default hopeTheme({
  ...
  blog: {
    medias: {
      Email: "https://a3245336455@outlook.com",
  ...
  locales: {
    ...
    "/zh/": {
     ...
     // sidebar: zhSidebar,
      ...
      blog: {
        description: "22带专,底层码农,干遍了外包,CRUD写尽了人情冷暖",
       // intro: "/zh/intro.html",
        name:"于子恩",
        roundAvatar: true, //头像变成原型
